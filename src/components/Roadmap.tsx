            ...
            <div className="inline-block glass p-6 rounded-xl border-2 border-dashed border-slate-300 dark:border-slate-600">
              ...
              {showThankYou ? (
                ...
                <button
                  ...
                  className="glow-cta cta-shine glass glass-button px-4 py-2 rounded-lg hover:scale-105 transition-all duration-300 text-sm font-medium disabled:opacity-50"
                >
